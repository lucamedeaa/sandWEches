...
export default function ModifyOffer({width,height,name,description,price,quantity,start,finish,active,products, close, show}) 
{
  return (
      <Modal style={{ height }}
      width={width}
      ...
      >
        ...
        <Spacer x='6'/>
        <TextField label="Description" width="300px" initialValue={description}/>
      </Row>
      <Spacer y="1"/>
